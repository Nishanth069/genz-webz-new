            ...
            <div className="max-w-7xl mx-auto px-6">
              <div className="grid md:grid-cols-3 gap-1px bg-white/5 border border-white/5 rounded-3xl overflow-hidden">
                {[
                  ...
                  <div key={i} className="bg-black p-12 space-y-8 hover:bg-white/[0.02] transition-colors">
          ...
          <section className="py-40 border-t border-white/5">
            <div className="max-w-4xl mx-auto px-6 text-center space-y-16">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
                <Link
                  href="/contact"
                  className="px-12 py-6 bg-white text-black font-bold uppercase tracking-widest text-xs rounded-full hover:scale-105 transition-transform text-center"
                >
                  Start an Enquiry
                </Link>
                <Link
